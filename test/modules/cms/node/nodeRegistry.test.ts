...
let MIGRATION_ONLY_NODE_TYPES: typeof import('@modules/cms/node/node.constants')['MIGRATION_ONLY_NODE_TYPES'];
let SELF_RESOLVING_REPEAT_NODE_TYPES: typeof import('@modules/cms/node/node.constants')['SELF_RESOLVING_REPEAT_NODE_TYPES'];
let nodeTypeRegistry: typeof import('@modules/cms/node/nodeRegistry')['nodeTypeRegistry'];
let nodeRegistry: typeof import('@modules/cms/node/nodeRegistry')['nodeRegistry'];
let nodeCapabilities: typeof import('@modules/cms/node/nodeRegistry')['nodeCapabilities'];
let NODE_TYPE_META: typeof import('@modules/cms/node/nodeRegistry')['NODE_TYPE_META'];
...
beforeAll(async () => {
    ({ ENodeType, MIGRATION_ONLY_NODE_TYPES, SELF_RESOLVING_REPEAT_NODE_TYPES } = await import('@modules/cms/node/node.constants'));
    ({ nodeTypeRegistry, nodeRegistry, nodeCapabilities, NODE_TYPE_META } = await import('@modules/cms/node/nodeRegistry'));
}, 30000);
