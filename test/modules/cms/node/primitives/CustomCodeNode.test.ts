...
let executeScriptsIn: typeof import('@modules/cms/node/primitives/CustomCodeNode')['executeScriptsIn'];
let escapeClosingTag: typeof import('@modules/cms/node/primitives/CustomCodeNode')['escapeClosingTag'];

beforeAll(async () => {
    ({ executeScriptsIn, escapeClosingTag } = await import('@modules/cms/node/primitives/CustomCodeNode'));
}, 30000);
