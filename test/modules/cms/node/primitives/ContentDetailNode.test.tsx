...
let ContentDetailNode: typeof import('@modules/cms/node/primitives/ContentDetailNode')['ContentDetailNode'];

beforeAll(async () => {
    ({ ContentDetailNode } = await import('@modules/cms/node/primitives/ContentDetailNode'));
}, 30000);
