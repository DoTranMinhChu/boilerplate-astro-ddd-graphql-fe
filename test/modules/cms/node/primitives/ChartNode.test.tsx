...
vi.mock('@modules/cms/node/nodeDataBinding', () => ({
...
let ChartNode: typeof import('@modules/cms/node/primitives/ChartNode')['ChartNode'];
let buildDonutSlices: typeof import('@modules/cms/node/primitives/ChartNode')['buildDonutSlices'];

beforeAll(async () => {
    ({ ChartNode, buildDonutSlices } = await import('@modules/cms/node/primitives/ChartNode'));
}, 30000);
