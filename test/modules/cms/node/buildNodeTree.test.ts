...
import { MAX_TREE_DEPTH } from '@modules/cms/node/node.constants';

function n(id: string, parentId: string | undefined, order: number): NodeDTO {
    return { id, pageId: 'p1', parentId, order, type: 'frame', layoutMode: 'flow', style: {}, layout: {}, props: {}, dataBinding: { mode: 'static' }, responsiveOverrides: {}, createdAt: '', updatedAt: '', deletedAt: undefined, animationRef: undefined, componentDefinitionId: undefined, componentSourceNodeId: undefined };
}
