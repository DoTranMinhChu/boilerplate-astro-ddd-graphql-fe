...
// established for this project. `include` already covers `test/**/*.test.tsx`.
import { describe, it, expect, vi } from 'vitest';
import { render, fireEvent } from '@solidjs/testing-library';
import { ContentDetailLayoutTab } from '@modules/cms/admin/nodeBuilder/ContentDetailLayoutTab';
