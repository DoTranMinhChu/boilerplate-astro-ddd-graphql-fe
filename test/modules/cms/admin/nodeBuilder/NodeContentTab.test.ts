...
let getAtPath: typeof import('@modules/cms/admin/nodeBuilder/NodeContentTab')['getAtPath'];
let setAtPath: typeof import('@modules/cms/admin/nodeBuilder/NodeContentTab')['setAtPath'];

beforeAll(async () => {
    ({ getAtPath, setAtPath } = await import('@modules/cms/admin/nodeBuilder/NodeContentTab'));
}, 30000);
