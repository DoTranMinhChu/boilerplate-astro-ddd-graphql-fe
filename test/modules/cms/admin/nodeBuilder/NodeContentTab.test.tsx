...
let NodeContentTab: typeof import('@modules/cms/admin/nodeBuilder/NodeContentTab')['NodeContentTab'];
let ENodeType: typeof import('@/modules/cms/node/node.constants')['ENodeType'];

beforeAll(async () => {
    ({ NodeContentTab } = await import('@modules/cms/admin/nodeBuilder/NodeContentTab'));
