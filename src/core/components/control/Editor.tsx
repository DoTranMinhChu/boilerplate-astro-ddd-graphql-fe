...
export function Editor(props: EditorProps) {
  ...
  onMount(() => {
    ...
    const instance = new EditorCore(contentRef, [marksModule, blocksModule, listsModule, linkModule, imageModule]);
