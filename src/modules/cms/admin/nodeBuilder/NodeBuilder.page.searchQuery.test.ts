// src/modules/cms/admin/nodeBuilder/NodeBuilder.page.searchQuery.test.ts
//
...
const PAGE_PATH = path.join(path.dirname(fileURLToPath(import.meta.url)), 'NodeBuilder.page.tsx');
