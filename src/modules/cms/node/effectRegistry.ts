...
export interface EffectDefinition {
    ...
    supportedTriggers: Array<'onLoad' | 'onScroll'>;
}
...
export const EFFECT_REGISTRY: EffectDefinition[] = [
    {
        ...
        defaults: { property: 'opacity', from: 0, to: 1, duration: 0.8 },
        preview: { property: 'opacity', from: 0, to: 1, duration: 0.8 },
        supportedTriggers: ['onLoad', 'onScroll'],
    },
    {
        id: 'fadeUp',
        ...
        defaults: { property: 'y', from: 32, to: 0, duration: 0.8 },
        preview: { property: 'y', from: 32, to: 0, duration: 0.8 },
        supportedTriggers: ['onLoad', 'onScroll'],
    },
    {
        id: 'slideLeft',
        ...
        defaults: { property: 'x', from: 48, to: 0, duration: 0.8 },
        preview: { property: 'x', from: 48, to: 0, duration: 0.8 },
        supportedTriggers: ['onLoad', 'onScroll'],
    },
    {
        id: 'scaleIn',
        ...
        defaults: { property: 'scale', from: 0.9, to: 1, duration: 0.8 },
        preview: { property: 'scale', from: 0.9, to: 1, duration: 0.8 },
        supportedTriggers: ['onLoad', 'onScroll'],
    },
    {
        id: 'headingReveal',
        ...
        defaults: { property: 'y', from: 30, to: 0, duration: 0.7 },
        preview: { property: 'y', from: 30, to: 0, duration: 0.7 },
        supportedTriggers: ['onLoad', 'onScroll'],
    },
    {
        id: 'bodyReveal',
        ...
        defaults: { property: 'opacity', from: 0, to: 1, duration: 0.6, delay: 0.1 },
        preview: { property: 'opacity', from: 0, to: 1, duration: 0.6, delay: 0.1 },
        supportedTriggers: ['onLoad', 'onScroll'],
    },
    {
        id: 'cardStagger',
        ...
        defaults: { property: 'opacity', from: 0, to: 1, duration: 0.6, stagger: 0.08 },
        ...
        preview: { property: 'opacity', from: 0, to: 1, duration: 0.6 },
        supportedTriggers: ['onScroll'],
    },
];
