    ...
    return (
        <div class="col-span-12">
            <label class="block text-xs font-bold text-slate-600 mb-1.5">
                {props.label ?? t('shared.agency.tenantFormField.label')} <span class="text-red-500 ml-0.5">*</span>
            </label>
            <Select
                ...
                clearable
                hasSubtext
                placeholder={t('shared.agency.tenantFormField.placeholder')}
                optionsQuery={{
            ...
            <p class="text-[10px] text-slate-400 mt-1">
                {t('shared.agency.tenantFormField.hint')}
            </p>
        </div>
    );
}
